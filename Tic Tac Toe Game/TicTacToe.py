...
def game_over():
    ...
    if row1 :
        result= True
        print("Congratulations... Player",board[0]+" won")
    elif row2 :
        result= True
        print("Congratulations... Player",board[3]+" won")
    elif row3 :
        result= True
        print("Congratulations... Player",board[6]+" won")
    elif col1 :
        result= True
        print("Congratulations... Player",board[0]+" won")
    elif col2 :
        result= True
        print("Congratulations... Player",board[1]+" won")
    elif col3 :
        result= True
        print("Congratulations... Player",board[2]+" won")
    elif dig1 :
        result= True
        print("Congratulations... Player",board[0]+" won")
    elif dig2 :
